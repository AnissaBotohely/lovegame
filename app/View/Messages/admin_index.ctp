<div class="messages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('id_dest'); ?></th>
			<th><?php echo $this->Paginator->sort('id_exp'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($message['Message']['id_dest']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['id_exp']); ?>&nbsp;</td>
